...
import { getWhatsAppUrl, getPhoneTelUrl } from '../config/contactConfig';
import './Contact.css';
...
const Contact = () => {
  ...
  const whatsappUrl = getWhatsAppUrl("Hola 👋, me gustaría recibir información sobre las terapias que ofrecéis en Esencialmente Psicología.");
    ...
    <div className="contact">
      ...
      <section className="contact-hero">
        <div className="container">
          ...
          <p>Estamos aquí para escucharte y resolver todas tus dudas</p>
        </div>
      </section>
          ...
          <div className="quick-contact">
            ...
            <div className="quick-contact-card">
              ...
              <div className="social-links-contact">
                <a href="https://www.instagram.com/esencialmentepsicologia?igsh=YXIwZ3h3bGF3c3Zu" target="_blank" rel="noopener noreferrer" className="social-btn instagram" aria-label="Instagram">
                ...
                {whatsappUrl && (
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="social-btn whatsapp" aria-label="WhatsApp">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                ...
                <a href="https://www.linkedin.com/company/esencialmente-psicolog%C3%ADa/" target="_blank" rel="noopener noreferrer" className="social-btn linkedin" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
