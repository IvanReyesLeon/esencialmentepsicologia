...
const sendTestEmail = async () => {
    ...
    // Simpler date format: "Domingo 21 Dic" or full but carefully handled?
    // User complaint: "cuándo: domingo, 21 de \n diciembre" -> weird break.
    // Solution:
    // 1. Stack Label and Value.
    // 2. Remove "de" for conciseness? Or just strict stacking.

    // Let's use standard full date but display it in a block below the label.
            ...
            <tr>
                <td align="center">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="600" class="content-bg" style="max-width: 600px; width: 100%; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                        ...
                        <!-- Card Details (Table for EMAIL compatibility, using Stack for Mobile) -->
                        <tr>
                        ...
                        <tr>
                            <td align="center" style="background-color: #fafafa; padding: 30px 20px; border-top: 1px solid #eeeeee;">
                                ...
                                <p style="color: #999; font-size: 13px; margin: 0 0 8px 0;">Carrer de l'Example 123, Barcelona</p>
    ...
    console.log('📧 Sending Final V2 Email (Stacked Layout)...');
