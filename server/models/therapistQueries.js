...
const createTherapist = async (therapistData) => {
    ...
    try {
      ...
      INSERT INTO therapists (full_name, bio, experience, photo, slug, meta_title, meta_description, methodology, license_number, label)
...
const updateTherapist = async (id, updates) => {
    ...
    try {
        ...
        const allowedFields = ['full_name', 'bio', 'experience', 'photo', 'slug', 'meta_title', 'meta_description', 'is_active', 'methodology', 'license_number', 'label'];
